 ...
 */
class getPierwszyControllerService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'App\Controller\PierwszyController' shared autowired service.
     *
     * @return \App\Controller\PierwszyController
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/PierwszyController.php';

        $container->services['App\\Controller\\PierwszyController'] = $instance = new \App\Controller\PierwszyController();
        ...
        ]))->withContext('App\\Controller\\PierwszyController', $container));
